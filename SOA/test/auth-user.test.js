...
const app = require('../backend/Authenticator Service/server'); // Link to your server file
const app1 = require('../backend/Statistics Service/server'); // Link to your server file
...
describe('Authenticator testing', () => {
    ...
    it('Get all users', function(done) {
        request.get('/auth/user/findusers')
                .end(function(error,response) {
    ...
    describe('Sign in testing', () => {
        after((done) => {
            request.post('/auth/user/deleteuser')
    ...
    describe('User endpoints testing', () => {
        ...
        describe("Update user's password", () => {
            it('No token given', (done) => {
                request.post('/auth/user/updatepassword')
                        .send(updatedPswUser)
                        .end(function(error,response) {
                            response.status.should.be.equal(401);
                            response.body.should.have.property('message').equal("Missing token!");
