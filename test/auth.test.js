...
describe.skip('Log in testing', () => {
    let userToken;

    describe('POST /saas1/login', () => {
        it('Fails to log in if username is missing',(done) => {
            request.post('/saas1/login')
                .set('Content-Type', 'application/x-www-form-urlencoded')
                .send("password=maria24")
    ...
    describe('POST /saas1/logout', () => {
        
        it('Don\'t logout if a user is not logged in',(done) => {
            request.post('/saas1/logout')
